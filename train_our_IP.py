...
for iDataSet in range(nDataSet):
    ...
    encoder_optim = torch.optim.SGD(list(encoder.parameters()), lr=LEARNING_RATE, momentum=0.9, weight_decay=WEIGHT_DECAY)
    ...
    for episode in range(EPISODE):
        ...
        logits_tar2 = (utils.euclidean_metric(query_features_tar, semantic_feature_tar))
